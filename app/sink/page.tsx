    ...
    <div>
      ...
      <section className=" max-w-[900px] mx-auto px-8 mt-16">
        ...
        <div className="my-10">
          ...
          <h3 className="t text-2xl font-extrabold my-5 mx-auto">About</h3>
          <div className="flex flex-col">
            <div className="flex-1">
              <Image
                alt=""
            ...
            <div className="flex-1 flex flex-col items-center md:justify-center md:items-start">
              <p className="my-10">
                On the about page, users can gain insight into the intention and
                purpose of the website, as well as understand its practical
                uses.
              </p>
              {homePage?.map((p) => {
                return (
