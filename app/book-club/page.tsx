    ...
    <div>
      ...
      <section className=" max-w-[900px] mx-auto px-8 mt-16">
        ...
        <div className="my-10">
          ...
          <h3 className="text-2xl font-bold my-10">Listing</h3>
          <div className="flex   flex-col  mt-10 px-4 py-2 ">
            <div className="flex-1 flex flex-col ">
              ...
              <p className="my-10">
                visually appealing book carousel or featured book section on the
                home page can catch the user's attention and highlight popular
                or trending books. This can create a sense of intrigue and
                encourage users to further explore the available book
                collection.
              </p>
