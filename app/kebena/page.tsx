            ...
            <Image
               ...
               />
                ...
                <div className='my-10'>
                    ...
                    <div className='flex   flex-col-reverse  mt-10 px-4 py-2 '>
                        <div className='flex-1 flex  flex-col   '>
                            <h3 className='text-2xl font-bold'>Evenet page</h3>
                            <p>Browse through upcoming, recent, and past events all in one convenient location! Whether you're planning ahead or looking to catch up on recent activities, our event page has you covered. Explore the latest happenings, revisit recent highlights, and discover past experiences. Stay connected with the pulse of the kebena community through our comprehensive event listings.</p>
